        ...
        <div class="container " id="home">
            <div class="row server_b_inner ">
                <div class="col-md-8 ">
                    ...
                    <br>
                    <br>
                    <a class="purchase-btn " href="signup.html ">GET STARTED NOW</a>
        ...
        <div class="container " id="service">
            ...
            <div class="row service_s_inner ">
                <div class="col-md-4 col-sm-4 col-xs-6 ">
                    <div class="ss_item ">
                        <img src="assets/img/icon/002-user-1.png " alt=" ">
                        <h4>Fill Out Your Profile</h4>
                        <p>Enter your details in signup section, Create your account and explore site.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 ">
                    <div class="ss_item ">
                        <img src="assets/img/icon/004-calendar.png " alt=" ">
                        <h4>Choose a Subscription packs</h4>
                        <p>You can choose a different plan according to your needs. The greater the terms of your plan,
                            the greater the savings.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 ">
                    <div class="ss_item ">
                        <img src="assets/img/icon/001-delivery-truck.png " alt=" ">
                        <h4>Check Your Mail &amp; Enjoy! </h4>
                        <p>Enter your shipping and payment information and expect your box in every months. </p>
                    </div>
                </div>
